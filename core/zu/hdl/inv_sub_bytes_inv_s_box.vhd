...
entity inv_sub_bytes_inv_s_box_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of inv_sub_bytes_inv_s_box_rom is 
...
entity inv_sub_bytes_inv_s_box is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of inv_sub_bytes_inv_s_box is
    component inv_sub_bytes_inv_s_box_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    inv_sub_bytes_inv_s_box_rom_U :  component inv_sub_bytes_inv_s_box_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
