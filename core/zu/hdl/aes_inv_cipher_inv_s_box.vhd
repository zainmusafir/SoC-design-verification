...
entity aes_inv_cipher_inv_s_box_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes_inv_cipher_inv_s_box_rom is 
...
entity aes_inv_cipher_inv_s_box is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_inv_cipher_inv_s_box is
    component aes_inv_cipher_inv_s_box_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_inv_cipher_inv_s_box_rom_U :  component aes_inv_cipher_inv_s_box_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
